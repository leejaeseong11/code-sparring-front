        ...
        <div id="layout">
            <div id="report-header">
                ...
                <div id="report-search-box">
                    <input id="search-text" type="number" placeholder="신고 번호 검색" @focus="searchReport" />
            ...
            <div class="report-content">
                <div v-for="report in reportList" :key="report.reportNo" class="report-object">
                    ...
                    <button class="report-info-bt" :id="'' + report.reportNo" @click="reportView(report)">조회</button>
                </div>
            </div>
