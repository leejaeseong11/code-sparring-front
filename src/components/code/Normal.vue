      ...
      <div id="code-side-layout">
        ...
        <div id="problem-des-container">
          <div id="problem-des-content">
            <textarea class="readonlyTextarea" :value="this.quizContent" readonly></textarea>
          </div>
        </div>
        ...
        <div id="testcase-des-container">
          <div
            id="testcase-des-content"
            v-for="testcase in testcaseList.slice(0, 3)"
        ...
        <div id="relative-code-container">
          <div id="member-title">
            {{
              ...
              this.memberName === roomMemberList[0].memberName
                ? '1P(' + this.memberName + ')'
                : '1P'
            }}
          </div>
          ...
          <div id="member-title">
            {{
              roomMemberList &&
              roomMemberList.length > 1 &&
              this.memberName === roomMemberList[1].memberName
                ? '2P(' + this.memberName + ')'
                : '2P'
            }}
          </div>
          ...
          <div id="member-title">
            {{
              roomMemberList &&
              roomMemberList.length > 2 &&
              this.memberName === roomMemberList[2].memberName
                ? '3P(' + this.memberName + ')'
                : '3P'
            }}
          </div>
          ...
          <div id="member-title">
            {{
              roomMemberList &&
              roomMemberList.length > 3 &&
              this.memberName === roomMemberList[3].memberName
                ? '4P(' + this.memberName + ')'
                : '4P'
            }}
          </div>
