<template>
    <div class="container">
        ...
        <div class="profile-icon-container">
            <img id="profile-icon" :src="'/images/icon/' + loginMember.memberProfileImg + '.png'" alt="profile" />
        </div>
        ...
        <div class="member-tier-container">
            ...
            <div class="content-container">
                <img class="rank-tier-icon" :src="'/images/rank/' + loginMember.memberTier.toLowerCase() + '.png'"
                    alt="my-tier" />
