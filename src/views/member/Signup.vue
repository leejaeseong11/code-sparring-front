      ...
      <section>
        ...
        <div class="info" id="info-id">
          ...
          <div
            class="error-msg"
            :class="{
              invalid: errMsg.id.invalid,
              fail: errMsg.id.fail,
              success: errMsg.id.success
            }"
          >
        ...
        <div class="info" id="info-pwd">
          <input
            ...
            @input="checkPwdValidHandler"
            @focus="clearAllErrMsg"
          />
          <div
            class="error-msg"
            :class="{
              invalid: errMsg.pwd.invalid,
              fail: errMsg.pwd.fail,
              success: errMsg.pwd.success
            }"
          >
        ...
        <div class="info" id="info-pwdRe">
          ...
          <div
            class="error-msg"
            :class="{
              invalid: errMsg.pwdRe.invalid,
              fail: errMsg.pwdRe.fail,
              success: errMsg.pwdRe.success
            }"
          >
        ...
        <div class="info" id="info-id">
          <div id="id-input">
            <input
              ...
              id="n"
              v-model="c.nick"
              placeholder="닉네임 입력 (추후변경가능)"
              @input="validateNick"
              @focus="clearAllErrMsg"
            />
            <button
              id="nick-check"
              @click="btNickDupchkClickHandler"
          ...
          <div
            class="error-msg"
            :class="{
              invalid: errMsg.nick.invalid,
              fail: errMsg.nick.fail,
              success: errMsg.nick.success
            }"
          >
...
export default {
  ...
  methods: {
    ...
    isFormValid() {
      // alert("isFormValid")
      const valid = this.privacyAgreed && this.isIdValid && this.isNickValid
